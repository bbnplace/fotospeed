<!-- About Section Start -->
    <section id="who-we-are" class="about-section section-padding">
        <div class="container">
                    ...
                    <div class="col-lg-6">
                        <div class="about-content">
                            ...
                            <div class="about-author">
                                <a href="{{ route('marketing.products') }}" class="theme-btn wow fadeInUp" data-wow-delay=".3s">Visit Showroom</a>
                                <div class="author-image wow fadeInUp" data-wow-delay=".5s">
                                    <img src="{{ config('app.url') }}/assets/img/about/author.png" alt="author-img">
                                    <div class="content">
                                        <span class="mb-2">Call to Expert</span>
                                        <h4><a href="tel:+389993938386">{{ $contact['phone'] }}</a></h4>
                                    </div>
                                </div>
                            </div>
                    </div>
                            ...
                            <div class="row g-4">
                                <div class="col-lg-6">
                                    <div class="thumb-image-1">
                                        <img src="{{ config('app.url') }}/assets/img/about/about-1.jpg" alt="img">
                                    </div>
                                    <div class="thumb-image-1 style-2">
                                        <img src="{{ config('app.url') }}/assets/img/about/about-2.jpg" alt="img">
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="thumb-image-1 style-3">
                                        <img src="{{ config('app.url') }}/assets/img/about/about-3.jpg" alt="img">
                                    </div>
                                    <div class="thumb-image-1 style-4">
                                        <img src="{{ config('app.url') }}/assets/img/about/about-4.jpg" alt="img">
                                    </div>
                                </div>
                            </div>
                        </div>
