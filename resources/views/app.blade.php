...
<html lang="en">
    ...
    @if($routePrefix == '/showroom')
        ...
        <script src="{{ env('APP_URL') }}/build/showroom/assets/app-BzPtnHzn.js" type="module"></script>
    @else
        <script src="{{ env('APP_URL') }}/build/oms/assets/app-CN3v_eNs.js" type="module"></script>
    @endif
