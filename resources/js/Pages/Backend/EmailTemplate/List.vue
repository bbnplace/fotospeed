...
const editItem = item => {
    router.get(route('email-template.edit', item.id))
}

const viewDetail = item => {
    router.get(route('email-template.view', item.id));
}
...
const deleteRecords = item => {
    ...
    router.post(route('email-template.delete'), form);
}

const deleteDialog = {
    title: "Confirm Delete",
    body: "Are you sure you want to delete the selected email templates?"
}
